        ...
        <div class="modal-content">
            ...
            <form role="form"   method="POST" action="{{ url('academics/create/batch') }}">
                ...
                <div class="modal-footer form-group">
                    <button type="submit" class="btn btn-info">Create Batch</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="row" align="left">
    <button class="btn btn-custom" data-toggle="modal" data-target="#myBatch"><i class="fa fa-fw fa-plus"></i>New Batch</button>
    <br>
</div>
            ...
            <div class="modal fade" id="myBatchUpdate{{$batches->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="myModalLabel">Update Batch Details</h4>
                        </div>
                        <div class="modal-body">
                            <form role="form"   method="POST" action="{{ url('academics/update/batch') }}">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label  for="form-username">Batch Name<span class="text-danger">*</span></label>
                                        <input type="text" name="Batch_name" placeholder="Batch Name..." class="form-username form-control"  required parsley-type="text">
                                    </div>

                                    <div class="form-group">
                                        <label  for="form-username">Batch Code<span class="text-danger">*</span></label>
                                        <input type="text" name="Batch_code" placeholder="Batch Code..." class="form-username form-control"  required parsley-type="text">
                                    </div>

                                    <div class="form-group">
                                        <label  for="form-username">Batch Year<span class="text-danger">*</span></label>
