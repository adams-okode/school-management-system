<!-- Add User Modal -->
<div class="modal fade" id="myTertiary" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Tertiary Education Details</h4>
            </div>
            <form role="form"   method="POST" action="{{ url('HR/employee/create') }}" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label  for="form-username">Qualifications<span class="text-danger">*</span></label>
                        <input type="text" name="Qualifications" placeholder="Qualifications..." class="form-username form-control"  required parsley-type="text">
                    </div>
...
<div class="row" align="left">
    <button class="btn btn-custom" data-toggle="modal" data-target="#myTertiary"><i class="fa fa-fw fa-plus"></i>Tertiary Education Details</button>
    <br>
</div>
