            ...
            <table id="datatable" class="table table-striped table-condensed table-bordered table-colored table-custom">
                ...
                @forelse($student as $students)
                    <tr>
                        ...
                        <td>
                            <a href="{{url('students/delete/students')}}/{{$students->id}}" class="btn btn-danger" onclick="return confirm('Do you want to delete {{$students->first_name}} {{$students->middle_names}}?')"><i class="fa fa-fw fa-trash"></i></a>
                            <a href="{{url('students/view/students')}}/{{$students->id}}" class="btn btn-custom"><i class=" fa fa-fw fa-pencil "></i></a>
                        </td>
                    </tr>
                @empty
                    <p>No Data Found</p>
