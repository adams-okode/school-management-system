            ...
            <form role="form"   method="POST" action="{{ url('/students/reports/batch/search') }}" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="search" placeholder="Course Name..." class="form-username form-control"  required parsley-type="text">
                    </div>
...
<div class="row" align="left">
    <button class="btn btn-custom" data-toggle="modal" data-target="#myCourse"><i class="fa fa-fw fa-plus"></i>Students per Course</button>
    <br>
</div>
